...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: Colors.black, body: pageViewContianer(textTheme));
  }

// widget containing data for the introduction screen
  Widget pageViewContianer(TextTheme textTheme) {
    return SizedBox(
                        ...
                        child: InkWell(
                          onTap: () {
                            if (btnText != 'Skip') {
                              ...
                              AppNavigation.pushReplacementTo(AppRoutes.routeLoginScreen);
                            }
